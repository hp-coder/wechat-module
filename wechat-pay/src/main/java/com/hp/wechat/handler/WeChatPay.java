package com.hp.wechat.handler;


import com.hp.wechat.config.WeChatPayConfig;
import com.hp.wechat.constant.WeChatPayConstant;
import com.hp.wechat.util.DateTimeUtil;
import com.hp.wechat.util.WeChatPayUtil;
...
public class WeChatPay {
    ...
    private final WeChatPayConstant.SignType signType;
    ...
    public WeChatPay(final WeChatPayConfig config, final String notifyUrl) throws Exception {
        this.config = config;
    ...
    private void checkWXPayConfig() throws Exception {
        ...
        if (this.config.getHttpConnectTimeoutMs() < 10 || this.config.getHttpConnectTimeoutMs() > 50_000) {
            throw new Exception("http connect timeout has to set between 10ms and 50000ms");
        }
        if (this.config.getHttpReadTimeoutMs() < 10 || this.config.getHttpReadTimeoutMs() > 50_000) {
            throw new Exception("http read timeout has to set between 10ms and 50000ms");
        }
    }
    ...
    private Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        if (WeChatPayConstant.SignType.MD5.equals(this.signType)) {
            reqData.put("sign_type", WeChatPayConstant.MD5);
        } else if (WeChatPayConstant.SignType.HMACSHA256.equals(this.signType)) {
            reqData.put("sign_type", WeChatPayConstant.HMACSHA256);
        }
     ...
     * @throws Exception e
     */
    private Map<String, String> fillRequestDataNotType(Map<String, String> reqData) throws Exception {
        reqData.put("appid", config.getAppId());
        reqData.put("mch_id", config.getMchId());
        reqData.put("nonce_str", WeChatPayUtil.generateNonceStr());
        reqData.put("sign", WeChatPayUtil.generateSignature(reqData, config.getKey(), this.signType));
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        String signTypeInData = reqData.get(WeChatPayConstant.FIELD_SIGN_TYPE);
        WeChatPayConstant.SignType signType;
        if (signTypeInData == null) {
            signType = WeChatPayConstant.SignType.MD5;
        } else {
            signTypeInData = signTypeInData.trim();
            if (signTypeInData.length() == 0) {
                signType = WeChatPayConstant.SignType.MD5;
            } else if (WeChatPayConstant.MD5.equals(signTypeInData)) {
                signType = WeChatPayConstant.SignType.MD5;
            } else if (WeChatPayConstant.HMACSHA256.equals(signTypeInData)) {
                signType = WeChatPayConstant.SignType.HMACSHA256;
            } else {
    ...
    private String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        return this.requestWithoutCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs, readTimeoutMs);
    }
    ...
    private String requestWithCert(String urlSuffix, Map<String, String> reqData,
        ...
        String msgUUID = reqData.get("nonce_str");
        String reqBody = WeChatPayUtil.mapToXml(reqData);
        return this.requestWithCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs, readTimeoutMs);
    }
     ...
     * @throws Exception e
     */
    private Map<String, String> processResponseXml(String xmlStr, boolean isFlag) throws Exception {
        ...
        if (return_code.equals(WeChatPayConstant.FAIL)) {
            return respData;
        } else if (return_code.equals(WeChatPayConstant.SUCCESS)) {
     ...
     * @throws Exception
     */
    private Map<String, String> sendRedPackProcessResponseXml(String xmlStr) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        Map<String, String> respData = WeChatPayUtil.xmlToMap(xmlStr);
        if (respData.containsKey(RETURN_CODE)) {
    ...
    public Map<String, String> microPay(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_MICROPAY_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.MICROPAY_URL_SUFFIX;
        }
     ...
     * @throws Exception e
     */
    private Map<String, String> sendRedPack(Map<String, String> reqData) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_SENDREDPACK_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.SENDREDPACK_URL_SUFFIX;
        }
    ...
    private Map<String, String> redPackRequestData(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception e
     */
    private Map<String, String> getRedPackInfo(Map<String, String> reqData) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_GETHBINFO_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.GETHBINFO_URL_SUFFIX;
        }
     ...
     * @throws Exception e
     */
    private Map<String, String> sendCoupon(Map<String, String> reqData) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_SEND_COUPON_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.SEND_COUPON_URL_SUFFIX;
        }
     ...
     * @throws Exception e
     */
    private Map<String, String> queryCouponsInfo(Map<String, String> reqData) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_QUERYCOUPONSINFO_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.QUERYCOUPONSINFO_URL_SUFFIX;
        }
        String respXml = this.requestWithCert(url, this.fillRequestDataNotType(reqData), config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml, false);
    }
     ...
     * @throws Exception e
     */
    private Map<String, String> queryCouponStock(Map<String, String> reqData) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_QUERY_COUPON_STOCK_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.QUERY_COUPON_STOCK_URL_SUFFIX;
        }
        String respXml = this.requestWithCert(url, this.fillRequestDataNotType(reqData), config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml, false);
    }
     ...
     * @throws Exception e
     */
    private Map<String, String> transfers(Map<String, String> reqData) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_TRANSFERS_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.TRANSFERS_URL_SUFFIX;
        }
    ...
    private Map<String, String> transfersRequestData(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> unifiedOrder(Map<String, String> reqData) throws Exception {
    ...
    private Map<String, String> unifiedOrder(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_UNIFIEDORDER_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.UNIFIEDORDER_URL_SUFFIX;
        }
     ...
     * @throws Exception
     */
    private Map<String, String> orderQuery(Map<String, String> reqData) throws Exception {
    ...
    private Map<String, String> orderQuery(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_ORDERQUERY_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.ORDERQUERY_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    private Map<String, String> reverse(Map<String, String> reqData) throws Exception {
    ...
    private Map<String, String> reverse(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_REVERSE_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.REVERSE_URL_SUFFIX;
        }
     ...
     * @throws Exception
     */
    private Map<String, String> closeOrder(Map<String, String> reqData) throws Exception {
    ...
    private Map<String, String> closeOrder(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_CLOSEORDER_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.CLOSEORDER_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    private Map<String, String> refund(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> refund(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_REFUND_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.REFUND_URL_SUFFIX;
        }
        String respXml = this.requestWithCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    private Map<String, String> refundQuery(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> refundQuery(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_REFUNDQUERY_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.REFUNDQUERY_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    private Map<String, String> downloadBill(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> downloadBill(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_DOWNLOADBILL_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.DOWNLOADBILL_URL_SUFFIX;
        }
        ...
        if (respStr.indexOf("<") == 0) {
            ...
            ret.put("return_code", WeChatPayConstant.SUCCESS);
     ...
     * @throws Exception
     */
    private Map<String, String> report(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> report(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_REPORT_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.REPORT_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
     ...
     * @throws Exception
     */
    private Map<String, String> shortUrl(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> shortUrl(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_SHORTURL_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.SHORTURL_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    private Map<String, String> authCodeToOpenid(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
    private Map<String, String> authCodeToOpenid(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WeChatPayConstant.SANDBOX_AUTHCODETOOPENID_URL_SUFFIX;
        } else {
            url = WeChatPayConstant.AUTHCODETOOPENID_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
    ...
    public Map<String, String> unifiedOrder(String notify_url, String openid, String body, String out_trade_no, String total_fee,
        ...
        data.put("fee_type", WeChatPayConstant.FEE_TYPE_CNY);
        // 通知地址	notify_url	是	String(256)	http://www.weixin.qq.com/wxpay/pay.php	异步接收微信支付结果通知的回调地址，通知url必须为外网可访问的url，不能携带参数。
        data.put("notify_url", notify_url);
        // 交易类型	trade_type	是	String(16)	JSAPI	小程序取值如下：JSAPI，详细说明见参数规定
        data.put("trade_type", WeChatPayConstant.TRADE_TYPE);
        ...
        data.put("appid", WechatPayConstant.APP_ID);
        // 商户号	mch_id	是	String(32)	1230000109	微信支付分配的商户号
        data.put("mch_id", WechatPayConstant.MCH_ID);
		// 随机字符串	nonce_str	是	String(32)	5K8264ILTKCH16CQ2502SI8ZNMTM67VS	随机字符串，长度要求在32位以内。推荐随机数生成算法
		data.put("nonce_str", nonce_str);
		// 签名类型	sign_type	否	String(32)	MD5	签名类型，默认为MD5，支持HMAC-SHA256和MD5。
        data.put("sign_type", WechatPayConstant.MD5);
        ...
        log.info("wxPay.unifiedOrder:" + resultMap);
    ...
    public Map<String, String> chooseWXPayMap(String prepay_id, String nonce_str) throws Exception {
        ...
        chooseWXPayMap.put("timeStamp", String.valueOf(System.currentTimeMillis()));
        chooseWXPayMap.put("nonceStr", nonce_str);
        chooseWXPayMap.put("package", "prepay_id=" + prepay_id);
        chooseWXPayMap.put("signType", WeChatPayConstant.MD5);

        log.info("wxPay.chooseWXPayMap:" + chooseWXPayMap.toString());

        // 生成支付签名
        String paySign = WeChatPayUtil.generateSignature(chooseWXPayMap, config.getKey());
        chooseWXPayMap.put("paySign", paySign);

        log.info("wxPay.paySign:" + paySign);
    ...
    public Map<String, String> refund(String notify_url, String transaction_id, String out_trade_no, String out_refund_no,
        ...
        data.put("refund_fee_type", WeChatPayConstant.FEE_TYPE_CNY);
        ...
        log.info("wxPay.refund:" + resultMap);
    ...
    public Map<String, String> transfers(String partner_trade_no, String openid, String amount, String desc, String spbill_create_ip) throws Exception {
        ...
        log.info("wxPay.transfers:" + resultMap);
    ...
    public Map<String, String> sendRedPack(String mch_billno, String openid, String amount, String act_name, String wishing, String remark, String spbill_create_ip) throws Exception {
        ...
        log.info("wxPay.sendRedPack:" + resultMap);
    ...
    public Map<String, String> getRedPackInfo(String mch_billno) throws Exception {
        ...
        log.info("wxPay.getRedPackInfo:" + resultMap);
    ...
    public Map<String, String> sendCoupon(String coupon_stock_id, String partner_trade_no, String openid) throws Exception {
        ...
        log.info("wxPay.sendCoupon:" + resultMap);
    ...
    public Map<String, String> queryCouponsInfo(String coupon_id, String stock_id, String openid) throws Exception {
        ...
        log.info("wxPay.queryCouponsInfo:" + resultMap);
    ...
    public Map<String, String> queryCouponStock(String coupon_stock_id) throws Exception {
        ...
        log.info("wxPay.queryCouponStock:" + resultMap);
    ...
    private String requestOnce(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        httpPost.addHeader("User-Agent", WeChatPayConstant.USER_AGENT + " " + config.getMchId());
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        try {
            //TODO domain需要有容灾的设置
            return requestOnce(WeChatPayConstant.DOMAIN_API, urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, useCert);
     ...
     * @return
     */
    private String requestWithoutCert(String urlSuffix, String uuid, String data) throws Exception {
     ...
     * @return
     */
    private String requestWithoutCert(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs) throws Exception {
     ...
     * @return
     */
    private String requestWithCert(String urlSuffix, String uuid, String data) throws Exception {
     ...
     * @return
     */
    private String requestWithCert(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs) throws Exception {
